...
https://github.com/grodansparadis/vscp-python-send-heartbeat  
"""
...
setup(
    ...
    py_modules=["pyvscp","pyvscpclasses","pyvscptypes"],
    ...
    data_files=[('script-sample-config', ['config.ini'])],

    # Scripts that will be made available
    scripts=['send-vscp-heartbeat.py', 'send-mqtt-heartbeat.py'],
